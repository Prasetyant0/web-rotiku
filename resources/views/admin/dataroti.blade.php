    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="row">
                    <div>
                        <a href="{{ route('admin.dataroti.create') }}" class="btn btn-primary">Tambah Data</a>
                        <div class="card flex-fill  mt-2">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Daftar data roti</h5>
                            </div>
                            <table class="table table-hover my-0">
                                <thead>
                                    <tr>
                                        <th class="d-none d-xl-table-cell">Gambar</th>
                                        <th class="d-none d-xl-table-cell">Nama Roti</th>
                                ...
                                <tbody>
                                    ...
                                    @if ($d->visibility)
                                        <tr>
                                            ...
                                            <td class="d-none d-xl-table-cell">{{ $d->roti }}</td>
                                            ...
                                            <td class="d-none d-md-table-cell">
                                                <a href="{{ route('admin.dataroti.destroy', $d->id_roti) }}"
