            ...
            <div class="view-barang">
                ...
                <div class="container-btn-t-k-stok">
                    ...
                    <div class="jumlah-beli-Container">
                        ...
                        <input id="jumlah" class="jumlah jumlah-input" value="{{ session('bayar.stok') }}" disabled>
                    ...
                    <div class="container-hargadanbarang">
                        ...
                        <div class="body-ring">
                            <div class="flex-display-ring">
                                <div class="lbl-ring">
                                    <p class="color-wt">Total Harga (<input type="number" disabled id="jumlahBarang" class="input-barang-style-beli" value="{{ session('bayar.stok') }}"> Barang)</p>
                                </div>
                                <div class="total harga barang">
                                    <p class="total-harga-ring">Rp <input id="totalHarga" class="input-intrac-style-beli" type="number" disabled value="{{ session('bayar.total_bayar') }}"></p>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div>
                            <div class="flex-display-ring">
                                ...
                                <div class="total harga barang">
                                    <p class="total-harga-ring total-tagihan">Rp <input type="number" id="totalTagihan" class="input-total-tagihan" value="{{ session('bayar.total_bayar') }}" disabled></p>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <button type="submit" style="width: 100%; border-radius:10px;" class="btn btn-primary button btn-bayar">
                            <span>Bayar</span>
                        </button>
                    </div>
                </div>
